...
type newFile.txt > myOriginalFile.txt
    ...
    echo "my line" > newFile.txt      rem appending <html> files to beginning of the html files
type myOriginalFile.txt >> newFile.txt
type newFile.txt > myOriginalFile.txt

echo "src-index.js" >> index.html rem appending js files to end of file


echo "src-index.js" >> index.html rem appending /</html> to end of file
